...
if __name__ == '__main__':
    ...
    img_dir = '/home/ruichen/data/CityPersons_DATASET/leftImg8bit/train'
    annFile = os.path.join(data_dir, 'instancesonly_filtered_gtFine_train.json')
    # coco = COCO(annFile)
    # print(len(coco))
    data_loader = Cityscapes(ann_file=annFile, root=img_dir, remove_images_without_annotations=False)
