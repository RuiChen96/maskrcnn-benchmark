...
# For example:
# img_dir = '/home/ruichen/Documents/Documents_from_ubuntu_1604/100SKUs_Test/testing_skus_101_200/testing_images'
# bbox_dir = '/home/ruichen/Documents/Documents_from_ubuntu_1604/100SKUs_Test/PredictionsByJuan/Syn+Real_1-200/inference/sku-box-test-101-200-v1'
# save_dir = '/home/ruichen/Documents/Documents_from_ubuntu_1604/100SKUs_Test/Failure_Cases_SKUs_101-200/1_Products'
...
# load annotations
anno_path = osp.join(bbox_dir, 'annotations_syn2real_iter1.json')
# DO NOT USE
bbox_path = osp.join(bbox_dir, 'annotations_domain_adaptaion.json')
...
for key, val in imgs.items():
    ...
    if len(dets[key]) == 0:
        ...
        cv2.imwrite(osp.join(save_dir, val['file_name']), im)
        continue
    ...
    for idx in range(0, num_det_bbox):
        ...
        det_title = '%s:%.2f' % (det_cls, det_socre)
